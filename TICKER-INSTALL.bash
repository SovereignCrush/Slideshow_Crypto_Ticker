...
# Since we run this script as sudo, we need to get the USER env for the display
...
# Are we running on a SERVER Edition?
IS_SERVER_EDITION=$(cat /etc/os-release | grep -i "server edition")
...
if [ "$IS_SERVER_EDITION" != "" ]; then

echo " "
echo "${red}SERVER EDITIONS are NOT supported (a Desktop interface is REQUIRED).${reset}"
...
echo " "
echo "$OS v$VER (CURRENT display info: ${DISPLAY_TYPE}; ID=${FIND_DISPLAY})${reset}"
echo " "
...
EOF
			 ...
			 # https://forums.raspberrypi.com/viewtopic.php?t=294014
     		 ...
     		 # If autostart file doesn't exist yet, create it, and append the ticker autostart code
                ...
                echo " "
                echo "${cyan}Creating / enabling USER-defined autostart (${AUTOSTART_LOCATION}), AND adding ticker autostart, please wait...${reset}"
                echo " "
